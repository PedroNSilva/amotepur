...
onde $r_i = y_i - R x_i$, $R = {Y}/{X}$, $S_{h,r}^2 = \displaystyle \frac{1}{N_h-1} \displaystyle \sum_{i \in U_h} (r_i - \overline R_h)^2$ e $\overline R_h = \displaystyle\frac{1}{N_h}\sum_{i \in U_h} r_i$. 
...
$$
V(\widehat Y_{AES}^{RS}) \doteq \displaystyle \sum_{h=1}^{H} \sum_{h=1}^{H} N_h^2 \left( \frac {1}{n_h} -  \frac {1}{N_h} \right) S_{h,r}^2 (\#eq:eqcal30)
$$

onde agora $r_i = y_i - R_h x_i$, $R_h = {Y_h}/{X_h}$ e $S_{h,r}^2 = \displaystyle \frac{1}{N_h-1} \displaystyle \sum_{i \in U_h} (r_i - \overline R_h)^2$.
...
$$
com $\widehat r_i = y_i - \widehat R_h x_i$, $\widehat R_h = \widehat Y_h / \widehat X_h$ e $s_{h,r}^2 = \displaystyle \frac{1}{n_h-1} \displaystyle \sum_{i \in s_h} r_i^2$.
