...
\begin{eqnarray}
 ...
 & = & \left| CORR_p \left( \widehat{R} , \widehat{X} \right) \right| \times \frac {DP_p(\widehat{X})}{X} \le CV_p(\widehat{X}) \\ \hfill(\#eq:eqraz14)
\end{eqnarray}
...
$V_{AAS}(\widehat{R})$                                           $\widehat{V}_{AAS}(\widehat{R}) =\displaystyle\frac{1}{\overline{x}^2}\left(\frac{1}{n}-\frac{1}{N}\right)\frac{1}{n-1}\displaystyle\sum_{i\in s}\left(y_i-\widehat{R}x_i\right)^2$  
