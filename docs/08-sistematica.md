...
## Composição de amostras sistemáticas simples 
...
A Tabela \@ref(tab:tabsis3) apresenta um resumo sobre a estimação de alguns parâmetros sob AS.

<center>
<table>
<caption>(#tab:tabsis3)Parâmetros e Estimadores sob AS</caption>
</table>
----------
Parâmetro                                                                           Estimador  
----------------------------------------------------------------------------------- ----------------------------------------------
...
$N$                                                                                   $\displaystyle \widehat N_{AS}=Kn_r\small,\,\, \small\text{ se  } N \text{ é desconhecido }$

$\displaystyle \overline Y=Y/N$                                                       $\displaystyle \overline {y}_{AS}=\frac KNt_r\small,\,\,\small\text{ se } N \text{ é conhecido }\\ \displaystyle  \overline{y}_{AS}= \frac {t_r}{n_r}=\overline y\small,\,\,\small\text{ se }N \text{ é desconhecido }$

$\displaystyle p = N_A/N$                                                             $\displaystyle \widehat {p}_{AS}=\frac KNn_a\small,\,\,\small \text{ se }  N \text{ é conhecido }\\  \displaystyle \widehat {p}_{AS}= \frac {n_a} {n_r}\small,\,\,\small\text{ se }N \text{ é desconhecido }$  


$\displaystyle V_{AS}(\widehat Y_{AS})=K\sum_{r=1}^K(t_r-\overline t)^2$               $\widehat V_{1AS} (\widehat Y_{AS}) = N^2\widehat V_{1AS} (\overline y_{AS})\small,\,\,\small\text{se}\, N\text{ é conhecido}$
                                                                                       $\small \text{e não houver ordenação das unidades na população}$                           $\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,$                                                                                                                                                                                                                 $\widehat V_{2AS}(\widehat Y_{AS}) = N^2\widehat V_{2AS}(\overline y_{AS})\small,\,\text{se}\, N\text{ é conhecido}$
                                                                                       $\small\text{e houver ordenação das unidades na população}$                         


$\displaystyle V_{AS}(\overline y_{AS})=\frac K{N^2}\sum_{r=1}^K(t_r-\overline t)^2$   $\widehat V_{1AS} (\overline y_{AS}) = \left( \frac {1}{n} - \frac 1 {N} \right) \frac {1}{n-1}\displaystyle \sum_{i \in s_r} (y_i - \overline y_{AS})^2\small,$ 
                                                                                       $\small \text{se}\, N\, \text{é conhecido e não houver ordenação na população}$                                                                        $\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,$                                                                                                                                               $\widehat V_{2AS}(\overline y_{AS}) = \left( \frac {1}{n} - \frac 1 {N} \right) \frac {1}{2(n-1)} \displaystyle\sum_{i \in s_r} (y_i - y_{i+K})^2\small,$
                                                                                       $\small\text{se}\,N\, \text{é conhecido e houver ordenação na população}$                 
----------
</center>  
