...
<table>
<caption>(#tab:tabdom1)Resumo de estimadores dos parâmetros média e total do domínio $d$ sob AAS</caption>
</table>
<center>
-----------------------------------------------   ------------------------------------
**Parâmetro do Domínio $d$**                      **Estimador do Domínio $d$ sob AAS**

$\overline{Y}_d=Y_d/N_d$                                         $\overline{y}_d=\widehat{Y}_d/\widehat{N}_d=\displaystyle\sum_{i\in s}y_{id}/n_d$
...
INCLUIR o conteúdo do arquivo Exercícios Unidade 06.R
