...
[@Cochran1977] mostra uma tabela, reproduzida na (\#tab: prop1) Tabela 5.1, com alguns valores mínimos do total de unidades observadas na amostra, $t_y$, onde a aproximação Normal pode se utilizada.
