...
$$
{\widehat Y}_{AIS/HT}=\frac1n  \left (N_A \sum_{k \in A} y_k +  (N_A + 1) \sum_{k∈\overline A} y_k \right)(\#eq:eqinv8)
$$
...
A média da população é obtida por:

$$
 {\overline y}_{AIS/HT}=\frac1{Nn}  \left (N_A \sum_{k \in A} y_k +  (N_A + 1) \sum_{k∈\overline A} y_k \right)(\#eq:eqinv11)
$$
...
$$
{\widehat Y}_{AIS/M} = \frac N {n-1}\left( \frac{m-1} m\sum_{i \in A}  y_i + \sum_{i \in \overline A} y_i \right) (\#eq:eqinv20)
$$
...
$$
{\overline y}_{AIS/M} = \frac 1 {n-1}\left( \frac{m-1} m\sum_{i \in A} y_i + \sum_{i \in \overline A} y_i \right) \,\, (\#eq:eqinv22)
$$
...
Parâmetro                                        Estimador
------------------------------------------------ --------------------
$\displaystyle Y$                                $\displaystyle{\widehat Y}_{AIS/HT}=\frac1n  \left (N_A \sum_{k \in A} y_k +  (N_A + 1) \sum_{k∈\overline A} y_k \right)$                           
                                                 $\displaystyle{\widehat Y}_{AIS/M} = \frac N {n-1}\left( \frac{m-1} m\sum_{i \in A}  y_i + \sum_{i \in \overline A} y_i \right)$
