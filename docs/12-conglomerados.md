...
Parâmetro                                                                                                                                           Estimador                             
--------------------------------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------
$\overline Y = {Y} / {N} = \displaystyle \frac 1 N \sum_{i\in C} Y_i$                                                                              $\displaystyle \overline y_N = \frac {\widehat Y}{N} = \frac {M} {N} \frac {1} {m} \displaystyle \sum_{i \in a} Y_i = \overline y_C / \overline N$                                                                      $\displaystyle \overline y_R = \frac {\widehat Y_R} {N} = \frac {1} {n} \displaystyle \sum_{i \in a} Y_i = \overline y_C / \overline n = \overline y$

$Y = \displaystyle \sum_{i \in C} Y_i = \sum_{i \in C} Y_i$                                                                                               $\displaystyle \widehat Y_{ACS} = \frac {M} {m} \displaystyle \sum_{i \in a} Y_i = M \overline y_C = \displaystyle \sum_{i \in a} \sum_{j \in C_i} d_{ij} y_{ij}$                                                                 $\displaystyle \widehat Y_R = \frac {N} {n} \displaystyle \sum_{i \in a} Y_i = N \overline y = \displaystyle \sum_{i \in a} \sum_{j\in C_i} w_{ij}^R y_{ij}$

$\displaystyle V_{AC1S} \left( \overline y_N \right) = \frac {1} {\overline N^2} \left( \frac 1 m - \frac 1 M \right) S_e^2$                                                         $\displaystyle \widehat V_{AC1S} \left( \overline y_N \right) = \frac {1} {\overline N^2} \left( \frac 1 m - \frac 1 M \right) s_e^2$

$V_{AC1S} \left( \overline y_R \right) \doteq \frac {1} {\overline N^2} \left( \frac {1} {m} - \frac {1} {M} \right) \frac {1} {M-1} \sum_{i \in C} N_i^2 \left( \overline Y_i - \overline Y \right)^2$             
$\widehat V_{AC1S} \left( \overline y_R \right) = \frac {1} {\overline n^2} \left( \frac 1 m - \frac 1 M \right) \frac {1} {m-1} \displaystyle \sum_{i \in a} N_i^2 \left( \overline {Y_i} - \overline y \right)^2$                                                   
$\displaystyle V_{AC1S} \left( \widehat Y_{AC1S} \right) = M^2 \left( \frac 1 m - \frac 1 M \right) S_e^2$                                                                                   $\displaystyle \widehat V_{AC1S} \left( \widehat Y_{AC1S} \right) = M^2 \left( \frac 1 m - \frac 1 M \right) s_e^2$

$V_{AC1S} \left( \widehat Y_R \right) \doteq M^2 \left( \frac 1 m - \frac 1 M \right) \frac {1} {M-1} \displaystyle \sum_{i \in C} N_i^2 (\overline Y_i - \overline Y)^2$                    $\widehat V_{AC1S} \left( \widehat Y_R \right) = M^2 \left( \frac 1 m - \frac 1 M \right) \frac {1} {m-1} \displaystyle \sum_{i \in a} N_i^2 (\overline Y_i - \overline y)^2$
