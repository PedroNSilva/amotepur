...
knitr::kable(quadro14_1, booktabs = TRUE, align= "lrrrrrr",
  ...
  caption = "Estimativas de totais, erros padrões e coeficientes de variação (CV) usando os estimadores HT e de regressão (GREG) para variáveis selecionadas"
  )
```
...
knitr::kable(quadro14_2, booktabs = TRUE, align= "lrrrrrr",
             format.args= list(big.mark = '.'),
  caption = "Estimativas de totais, erros padrões e coeficientes de variação (CV) usando os estimadores HT e pós-estratificação (PS-Região) para variáveis selecionadas"
  )
```
