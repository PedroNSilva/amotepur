...
$$\sum_{i=1}^{50} y_i = 128.080; \quad \sum_{i=1}^{50} x_i =1.067; \quad \widehat S_y ^2=6.244.516; \quad \widehat S_x ^2=454,51;\quad \widehat S_{xy}=45.399$$
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcalib8)", "Peso e quantidade de açúcar, ambos em libras, nas laranjas da amostra", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcalib11)", "Diâmetro e idade das árvores da amostra", "</caption>"),"</table>", sep ="\n")
```
----------
