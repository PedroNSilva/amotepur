...
cat("<table>",paste0("<caption>","(#tab:tabrazao1)","Densidade por Unidade da Federação, média das razões e razão das médias para o Brasil","</caption>"),"</table>", sep ="\n")
```

---------
Unidade da Federação           Densidade ($Hab/km^2$)
----------------------------- ----------------------- 
Rondônia                                          6,6
...
#setwd("C:\\Users\\Vermelho\\Documents\\GitHub\\amotepur\\amotepur\\Dados")
getwd()
