...
**(#exm:exmrazao1)** Considere as densidades de habitantes por área (em $km^2$) das unidades da federação brasileiras, conforme o Censo 2010. Neste exemplo, vemos como uma discrepância grande pode ocorrer entre as duas quantidades (a razão de médias e a médias das razões), quando os valores de $r_i$  são muito dispersos.
...
**(#exe:exerazao1)** Identifique e defina duas razões que você já tenha utilizado em seu trabalho.

**(#exe:exerazao2)** Estimando Razões e Médias de Razões
