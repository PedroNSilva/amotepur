...
```{r,hierar1,echo=F,fig.cap="Ilustração da hierarquia com vários níveis (vários para um)",out.width = '100%'}
...
Seria possível implementar um quarto estágio selecionando apenas uma parte dos alunos de cada turma selecionada para responderem ao questionário da pesquisa, porém por facilidades operacionais foi decidido pela inclusão de todos os alunos na amostra final.
...
$$
\displaystyle V_{AC1S} \left( \widehat Y_{AC1S/HT} \right) = M^2 \frac {1-f} {m} S_e^2 \,\,(\#eq:eqcong2)
$$ 
...
$\scriptstyle V_{AC1S}\left(\widehat Y_{AC1S/HT} \right)= M^2 \frac {1-f} {m} S_e^2$                                                                                                  $\scriptstyle \widehat V_{AC1S} \left( \widehat Y_{AC1S/HT}\right)= M^2 \left( \frac 1 m - \frac 1 M \right) s_e^2$
...
\end{eqnarray}
$$
$V_{UPA}$ é a componente de variância de $\widehat Y_{AC2/HT}$ proveniente da amostragem de UPAs (estágio 1), isto é, variância caso amostragem conglomerada em um estágio fosse usada (sem fazer subamostragem);
...
Um estimador da variância de $\widehat Y_{AC2PPTS}$ é dado por: 
...
$$ 
V_{AAS} (\overline y) = V_{AC2PPTC} (\overline y_{AC2PPTC}) \big/ EPA(AC2PPTC; \, AAS)
$$

Então podemos escrever:

$$ 
\displaystyle \frac {V_{AC2PPTC} (\overline y_{AC2PPTC})} {EPA(AC2PPTC; \, AAS)} = \left( \frac {1} {n} - \frac {1} {N} \right) S_y^2 \,\, (\#eq:eqcong50) 
$$

Daí segue-se que:

$$
\frac {1} {n S_y^2} = \frac {1} {N} S_y^2 + \displaystyle \frac {V_{AC2PPTC} (\overline y_{AC2PPTC})} {EPA(AC2PPTC; \, AAS)} \,\, \Longrightarrow 
$$

$$
n = S_y^2 \Big/ \left( \frac {1} {N} S_y^2 + \displaystyle \frac {V_{AC2PPTC} (\overline y_{AC2PPTC})} {EPA(AC2PPTC; \, AAS)} \, \right) \,\,\, \Longrightarrow 
$$
$$ 
n = N S_y^2 \Big/ \left( S_y^2 + N \displaystyle \frac {V_{AC2PPTC} (\overline y_{AC2PPTC})} {EPA(AC2PPTC; \, AAS)} \, \right) \,\,\,(\#eq:eqcong51)
$$
...
$$
n = N S_y^2 \Big/ \left( S_y^2 + \displaystyle \frac {N d^2} {z_{\alpha/2}^2 EPA(AC2PPTC; \, AAS)} \, \right)
$$
