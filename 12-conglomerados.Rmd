...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcong6)", "Efeitos do plano amostral sob AC1S por tamanho do conglomerado e valor do coeficiente de correlação intraclasse", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
