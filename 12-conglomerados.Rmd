...
cat("<table>",paste0("<caption>", "(#tab:tabcong1)", "Exemplos de possíveis conglomerados", "</caption>"),"</table>", sep ="\n")
```
---------- 
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcong2)", "Definição dos tamanhos da população e da amostra na AC1", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcong3)", "Definição de parâmetros populacionais nos conglomerados e na população", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
Definição                                                           Parâmetro                              
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcong4)", "Descrição das informações amostrais na AC1S", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcong5)", "Parâmetros e respectivos estimadores sob AC1S", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
Parâmetro                                                                                                                                                                                  Estimador                             
...
$\scriptstyle Y=N\overline Y=\sum_{i \in C} Y_i$                                                                                                                                           $\scriptstyle\widehat Y_{AC1S}= \frac{M}{m}\sum_{i\in a}Y_i=M\overline y_C=\sum_{i\in a}\sum_{j\in C_i}d_{ij}y_{ij}$                                                                                                       $\scriptstyle\widehat Y_R = \frac {N} {n}\sum_{i \in a} Y_i = N \overline y=\sum_{i \in a} \sum_{j\in C_i} w_{ij}^R y_{ij}$
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcong6)", "Efeitos de plano amostral sob AC1S por tamanho do conglomerado e valor do coeficiente de correlação intraclasse", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
...
& = & V_1 \left[ \frac {1} {m} \displaystyle \sum_{i \in a} \frac {Y_i} {p_i} \right] + E_1 \left[ \frac {1} {m^2} \sum_{i \in a} \frac{N_i^2}{p_i} \left( \frac {1} {n_i} - \frac {1} {N_i} \right) S_i^2 \right] \\
& = & \frac{1} {m} \displaystyle \sum_{i \in U} \left( \frac {Y_i} {p_i} - Y \right)^2 p_i + \frac {1} {m} \sum_{i \in U} \frac{N_i^2}{p_i} \left( \frac {1} {n_i} - \frac {1} {N_i} \right) S_i^2 \,\,  
...
& = & V_1 \left[ \displaystyle \sum_{i \in a} \frac {Y_i} {mp_i} \right] + E_1 \left[ \sum_{i \in a} \frac {N_i^2} {{m^2}p_i^2}  \left( \frac {1} {n_i} - \frac {1} {N_i} \right) S_i^2 \right] \\
& = & \frac {1} {m} \frac {M} {M-1} \displaystyle \sum_{i \in C} \left( \frac {Y_i} {p_i} - Y \right)^2 (1 - m p_i) p_i \\ 
& & + \sum_{i \in C} \frac {N_i^2}{m p_i} \left( \frac {1} {n_i} - \frac {1} {N_i} \right) S_i^2 
\,\,  
...
```{r, results="asis", echo=FALSE}
cat("<table>", paste0("<caption>", "(#tab:tabcong7)", "Parâmetros e respectivos estimadores sob os Planos AC2AAS, AC2PPTC e AC2PPTPS", "</caption>"),"</table>", sep ="\n")
```
**PROPOSTA 1**
<center>
...
Parâmetro                                                                                                                                                                                                                     Estimador                  
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------
$\scriptstyle Y=\sum_{i \in C} Y_i$                                                                                                                                                                                                 $\scriptstyle\widehat Y_{AC2AAS}=\frac{M}{m}\sum_{i\in a}\widehat Y_i \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,$
...
$\scriptstyle V_{AC2AAS}\left(\widehat Y_{AC2AAS}\right)=M^2\left(\frac1m-\frac1M\right)\frac1{M-1}\sum_{i\in C}\left(Y_i-\overline Y_C\right)^2+\frac{M}m \sum_{i\in C}N_i^2\left(\frac1{n_i}-\frac1{N_i}\right)S_i^2$                $\scriptstyle\widehat V_{AC2AAS}\left(\widehat Y_{AC2AAS}\right)=M^2\left(\frac{1}{m}-\frac{1}{M}\right)\frac{1}{m-1}\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,$                                                                                                                                                                          $\scriptstyle\sum_{i\in a}\left(\widehat Y_i- \overline y_C\right)^2+\frac{M}{m}\sum_{i\in a}N_i^2\left(\frac{1}{n_i}-\frac{1}{N_i}\right)\widehat S_i^2$ 
                                                                                       
$\scriptstyle V_{AC2PPTC}\left(\widehat Y_{AC2PPTC}\right)=\frac{1}{m}\sum_{i\in U}\left(\frac{Y_i}{p_i}-Y\right)^2p_i+\frac{1}{m}\sum_{i\in U}\frac{1}{p_i} N_i^2\left(\frac{1}{n_i}-\frac{1}{N_i}\right)S_i^2$                       $\scriptstyle\widehat V_{AC2PPTC}\left(\widehat Y_{AC2PPTC}\right)=\frac{\sum_{i\in a}\left(\frac{\widehat Y_i}{p_i}-\widehat Y_{AC2PPTC}\right)^2}{m(m-1)}$

$\scriptstyle V_{AC2PPTPS}\left(\widehat Y_{AC2PPTPS}\right)=\frac{1}{m}\frac{M}{M-1}\sum_{i\in C}\left(\frac{Y_i}{p_i}-Y\right)^2(1-m p_i)p_i+\sum_{i\in C}\frac{N_i^2}{mp_i}\left(\frac{1}{n_i}-\frac{1}{N_i}\right)S_i^2$                                                                                                                                                                  $\scriptstyle\widehat V_{AC2PPTPS}\left(\widehat Y_{AC2PPTPS}\right)=\frac{1}{m}\frac{M}{M-1}\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,$                                                                                                                                                                                           $\scriptstyle\sum_{i\in a}\left(\frac{\widehat Y_i}{p_i}-\widehat Y_{AC2PPTPS}\right)^2(1-mp_i)p_i\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,$                                                                                                                                                                                                                                                                                                                                                                $\scriptstyle +\sum_{i\in a}\frac{N_i^2}{m p_i}\left(\frac{1}{n_i}-\frac{1}{N_i}\right)\widehat S_i^2$ 
---------
</center>
**PROPOSTA 2**
<center>
...
$\scriptstyle V_{AC2AAS}\left(\widehat Y_{AC2AAS}\right)$      $\scriptstyle\widehat V_{AC2AAS}\left(\widehat Y_{AC2AAS}\right)=M^2\left(\frac{1}{m}-\frac{1}{M}\right)\frac{1}{m-1}\sum_{i\in a}\left(\widehat Y_i- \overline y_C\right)^2+\frac{M}{m}\sum_{i\in a}N_i^2\left(\frac{1}{n_i}-\frac{1}{N_i}\right)\widehat S_i^2$ 
                                                                                       
                                                                                       
$\scriptstyle V_{AC2PPTC} \left( \widehat Y_{AC2PPTC} \right)$ $\scriptstyle\widehat V_{AC2PPTC}\left(\widehat Y_{AC2PPTC}\right)=\frac{1}{m(m-1)}\sum_{i\in a}\left(\frac{\widehat Y_i}{p_i}-\widehat Y_{AC2PPTC} \right)^2$

$\scriptstyle V_{AC2PPTPS}\left(\widehat Y_{AC2PPTPS}\right)$  $\scriptstyle\widehat V_{AC2PPTPS}\left(\widehat Y_{AC2PPTPS}\right)=\frac{1}{m}\frac{M}{M-1}\sum_{i\in a}\left(\frac{\widehat Y_i}{p_i}-\widehat Y_{AC2PPTPS}\right)^2(1-mp_i)p_i+\sum_{i\in a}\frac{N_i^2}{m p_i}\left(\frac{1}{n_i}-\frac{1}{N_i}\right)\widehat S_i^2$ 
---------
</center>
**PROPOSTA 3**
<center>
...
$V_{AC2PPTPS} \left( \widehat Y_{AC2PPTPS} \right)$                 $\widehat V_{AC2PPTPS} \left( \widehat Y_{AC2PPTPS} \right) = \displaystyle \frac {1} {m} \frac {M} {M-1} \displaystyle \sum_{i \in a} \left( \frac {\widehat Y_i} {p_i} - \widehat Y_{AC2PPTPS} \right)^2$ 
                                                                                  $\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\, (1 - m p_i) p_i+ \displaystyle \sum_{i \in a} \frac {N_i^2} {m p_i}  \left( \frac {1} {n_i} - \frac {1} {N_i} \right) \widehat S_i^2$ 
---------
</center>
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcong8)", "Resultados obtidos para a amostra", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>", paste0("<caption>", "(#tab:tabcong9)", "Valores populacionais", "</caption>"),"</table>", sep ="\n")
```
----------
 $U_i$   $y_i$               $U_i$   $y_i$
------- ------- ------------ ------- -------  
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>", paste0("<caption>", "(#tab:tabcong10)", "Conglomerados e respectivas unidades formadoras", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>", paste0("<caption>", "(#tab:tabcong11)", "Número de domicílios e domicílios alugados na amostra de 20 quarteirões", "</caption>"),"</table>", sep ="\n")
```
----------
...
**(#exr:execong7)** De uma população com 10.000 conglomerados e 50.000 unidades elementares uma amostra aleatória simples sem reposição de 10 conglomerados foi selecionada. Desses conglomerados temos as informações mostradas na Tabela \@ref(tab:tabcong12):
  ...
  <center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcong12)", "Valores observados para os conglomerados da amostra", "</caption>"),"</table>", sep ="\n")
```
----------
...
**(#exr:execong8)** Uma cadeia de supermercados tem lojas em 32 cidades. Um órgão de fiscalização deseja estimar a proporção das lojas da cadeia que não seguem determinados padrões especificados de higiene.  Amostra de conglomerados é desejável no caso, devido aos altos custos de locomoção entre as cidades; assim foi decidido por uma amostra de conglomerados em dois estágios, com equiprobabilidade nos dois estágios de seleção, contendo aproximadamente metade das lojas de 4 cidades amostradas. Os dados amostrais aparecem na Tabela \@ref(tab:tabcong13):
  ...
  <center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcong13)", "Valores observados para a amostra", "</caption>"),"</table>", sep ="\n")
```
----------
