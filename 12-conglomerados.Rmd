...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcong5)", "Estimadores do total, média e respectivas variâncias sob AC1S", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
Estimador                             
...
```{r, results="asis", echo=FALSE}
cat("<table>", paste0("<caption>", "(#tab:tabcong7)", "Estimadores do total e respectivas variâncias sob AC2S, AC2PC e AC2PS", "</caption>"),"</table>", sep ="\n")
```
<center>
