...
<center>
```{r, baralho, echo=FALSE, fig.cap="Ilustração de unidades elementares “naturalmente” agrupadas", out.width="80%"}
knitr::include_graphics("Figuras/baralho.png") 
```
</center>
...
<center>
```{r, baralhoAC1, echo=FALSE, fig.cap="Ilustração da seleção de amostragem conglomerada em um estágio", out.width="80%"}
...
<center>
```{r, baralhoAC2, echo=FALSE, fig.cap="Ilustração da seleção de amostragem conglomerada em 2 estágios ", out.width="80%"}
