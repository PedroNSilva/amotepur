...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcong2)", "Tamanhos da população e da amostra na AC1", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcong3)", "Parâmetros populacionais nos conglomerados e na população", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
Definição                                                           Parâmetro                              
