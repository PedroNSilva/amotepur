...
cat("<table>",paste0("<caption>", "(#tab:tabestr1)", "Parâmetros e respectivos estimadores sob AES", "</caption>"),"</table>", sep ="\n")
```
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabestr5)", "Informações cansitárias sobre a variável de interesse", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabestr9)", "Falta no mês para cada trabalhador selecionado", "</caption>"),"</table>", sep ="\n")
```
---------- 
