...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabestr2)", "Referências sobre delimitação ótima de estratos", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabestr3)", "Valores de $EPA$ para valores variados de $H$ e de correlação", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
...
<center>
```{r, precisaovsestratos,echo=FALSE, fig.cap="Ganhos de precisão *versus* número de estratos", out.width = '60%'}
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabestr4)", "Dados observados na amostra, por estrato", "</caption>"),"</table>", sep ="\n")
```
----------
                                     Estrato 1          Estrato 2 
------------------------------ ------------------- -------------------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabestr5)", "Informações da estratificação das fazendas de soja", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabestr6)", "Informações censitárias sobre a variável de interesse", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabestr7)", "Estratificação das lojas e resultados da amostra", "</caption>"),"</table>", sep ="\n")
```
---------- 
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabestr8)", "Resultados observados na amostra", "</caption>"),"</table>", sep ="\n")
```
---------- 
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabestr9)", "Tamanho e variância por estrato", "</caption>"),"</table>", sep ="\n")
```
---------- 
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabestr10)", "Faltas no mês para cada trabalhador selecionado", "</caption>"),"</table>", sep ="\n")
```
---------- 
