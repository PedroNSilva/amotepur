...
A Tabela \@ref(tab:tabcalib1) apresenta uma comparação dos estimadores Horvitz-Thompson e de calibração. 

```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabcalib1)", "Comparação dos estimadores Horvitz-Thompson e de calibração.", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
...
Variância        $V\left(\displaystyle\sum_{k \in s}d_k y_{kj}\right)$  $V\left(\displaystyle\sum_{k \in s}w_k E_{kj}\right)$
---------
</center>
