...
Uma *amostra aleatória* $s (s\subset U)$ é selecionada, e os valores de ${\bf  y}_k$ para $k \in s$ são observados para fazer inferência sobre alguns *parâmetros populacionais* de interesse.
...
\begin{equation}
{\bf \widehat T}_x^C = \sum_{k \in s}w_k{\bf x}_k\,\,(\#eq:eqcal3)
\end{equation}
...
```{r, figcalib1, echo=FALSE, encoding="UTF-8", fig.cap="Residuos para o modelo de regressão da população para os estimadores de Horvitz-Thompson (esquerda) e de calibração (direita)"}
...
Outra implementação da abordagem acima está disponível em *BASCULA*, que é um sistema desenvolvido pelo Statistics Netherlands (veja [@Nieuwenbroek2002]). A principal diferença entre o GES e o BASCULA é o algoritmo usado para calcular os pesos de calibração. 
...
\begin{array}{l l l l c cl} \hline
 \textbf{Esquema de} &  \textbf{Número de} & \textbf{Estimativa} &\textbf{Erro} & \textbf{Intervalo de} &\textbf{confiança (95%)}
 \\ \textbf{ponderação} &  \textbf{parâmetros} &  &\textbf{padrão} & \textbf{LI} &\textbf{LS}
 \\\hline \text{Nenhum} & 1 & 23494 & 182 & 23137 & 23852 
  \\ \text{Sexo} & 2 & 23613 & 182 & 23137 & 23852
  \\ \text{Idade} & 6 & 23990 & 170 & 23657 & 24323
  \\ \text{Mar} & 2 & 23624 &161 & 23308 & 23940 
  \\
  \\ \text{Sexo x Idade} & 12 & 24012 & 167 & 23684 & 24340
  \\ \text{Sexo + Idade} & 7 & 24065 & 168 & 23736 & 24349
  \\ \text{Sexo x Mar} & 4 & 23809 & 160 & 23496 & 24123
  \\ \text{Sexo + Mar} & 3 & 23675 & 160 & 23361 & 23990
  \\ \text{Idade x Mar} & 12 & 23987 &153 & 23687 & 24287   
  \\ \text{Idade + Mar} & 7 & 24071 &154 & 23769 & 24374
  \\
  \\ \text{Sexo + Idade + Mar} & 8 & 24104 & 154 & 23802 & 24405 
  \\ \text{(Sexo x Mar) + Idade} & 9 & 24172 & 153 & 23871 & 24472
  \\ \text{(Sexo x Idade) + Mar} & 13 & 24078 & 153 & 23777 & 24379
  \\ \text{(Idade x Mar) + Sexo} & 13 & 24004 & 152 & 23705 & 24302
  \\ \text{(Sexo x Idade) + (Sexo x Mar} & 14 & 24149 & 153 & 23849 & 24449
  \\ \text{(Idade x Mar) + (Sexo x Mar} & 14 & 24076 & 152 & 23778 & 24374
  \\ \text{(Sexo x Idade) + (Idade x Mar} & 18 & 23985 & 152 & 23687 & 24283 
  \\ \text{(Sexo x Idade) + (Idade x Mar)} & & & & &  
  \\ \text{+(Sexo x Mar} & 19 & 24054 & 152 & 23757 & 24352   
  \\ \text{Sexo x Idade x Mar} & 24 & 24048 & 152 & 23751 & 24345
 \\\hline
\end{array}
</center>
