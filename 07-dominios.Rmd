...
cat("<table>",paste0("<caption>", "(#tab:tabdom1)", "Estimadores dos parâmetros proporção, média e total do domínio $d$ sob AAS", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabdom2)", "Distância percorrida para chegar ao trabalho pelos 24 entrevistados", "</caption>"),"</table>", sep ="\n")
```
------- ------- ------- ------ ------ ------- ------- -------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabdom4)", "Tabela de frequências do número de cáries por criança", "</caption>"),"</table>", sep ="\n")
```
--------------------------- -- -- -- -- -- -- -- -- -- -- ---
