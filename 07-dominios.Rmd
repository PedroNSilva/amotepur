...
$$
V_{AAS}(\overline{y}_c) \doteq \frac{1} {p_c^2} \left( \frac 1 n - \frac{1}{N} \right) \frac{1}{N-1} \displaystyle \sum_{i \in U} \left( y_{ic} -\overline{Y_c}\, c_i \right)^2 \\ \quad\quad\quad\quad\quad\quad\quad\quad\quad= \frac{1}{p_c^2} \left( \frac 1 n - \frac{1}{N} \right) \frac{1}{N-1} \displaystyle \sum_{i \in U} c_i \left( y_i - \overline{Y_c} \right)^2   (\#eq:eqdom12)
$$
...
$Y_c=N_c\overline{Y_c}$                                $\widehat{Y}_c=N/n\displaystyle\sum_{i\in s} y_{ic},\quad N_c\,\,\text{desconhecido}$
