...
<center>
```{r,results="asis",echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabsis6)","Principais resultados para os estimadores sob *AS*", "</caption>"),"</table>", sep ="\n")
```
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabsis7)","Composição das familias dos domicílios da rua","</caption>"),"</table>", sep ="\n")
```
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabsis8)","Número de sementes germinadas por canteiro","</caption>"),"</table>", sep ="\n")
```
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabsis9)","Quantidade de alimento, em onças, por lata na AS.","</caption>"),"</table>", sep ="")
```
----------
  A     B     C     D     E     F
----- ----- ----- ----- ----- -----
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabsis10)","Valores da variável $y$ para a população","</caption>"),"</table>", sep ="\n")
```
----------
 i     I   II   III   IV   V
----- --- ---- ----- ---- --- 
