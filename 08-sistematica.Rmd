...
(2) Selecione a *partida aleatória* $r$, igual a um número inteiro sorteado entre $1$ e $K$ com probabilidades iguais a $1/K$ para todos os inteiros no intervalo; sendo assim, $r$ tem distribuição Uniforme Discreta de parâmetro $K$, ou seja, $r \approx UD(K)$.
...
A Tabela \@ref(tab:tabsis3) apresenta um resumo sobre a estimação de alguns parâmetros na AS.

<center>
```{r,results="asis",echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabsis3)","Parâmetros e Estimadores sob AS", "</caption>"),"</table>", sep ="\n")
```
----------
Parâmetro                                                                           Estimador  
----------------------------------------------------------------------------------- ----------------------------------------------
...
$N$                                                                                   $\displaystyle \widehat N_{AS}=Kn_r\scriptstyle,\,\, \scriptstyle\text{ se  } N \text{ é desconhecido }$

$\displaystyle \overline Y=Y/N$                                                       $\displaystyle \overline {y}_{AS}=\frac KNt_r\scriptstyle,\,\,\scriptstyle\text{ se } N \text{ é conhecido }\\ \displaystyle  \overline{y}_{AS}= \frac {t_r}{n_r}=\overline y\scriptstyle,\,\,\scriptstyle\text{ se }N \text{ é desconhecido }$

$\displaystyle p = N_A/N$                                                             $\displaystyle \widehat {p}_{AS}=\frac KNn_a\scriptstyle,\,\,\scriptstyle \text{ se }  N \text{ é conhecido }\\  \displaystyle \widehat {p}_{AS}= \frac {n_a} {n_r}\scriptstyle,\,\,\scriptstyle\text{ se }N \text{ é desconhecido }$  


$\displaystyle V_{AS}(\widehat Y_{AS})=K\sum_{r=1}^K(t_r-\overline t)^2$               $\widehat V_{1AS} (\widehat Y_{AS}) = N^2\widehat V_{1AS} (\overline y_{AS})\scriptstyle,$
                                                                                       $\scriptstyle \text{se}\, N\, \text{é conhecido e não houver ordenação das unidades na população}$                           $\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,$                                                                             $\widehat V_{2AS}(\widehat Y_{AS}) = N^2\widehat V_{2AS}(\overline y_{AS})\scriptstyle,$
                                                                                       $\scriptstyle \text{se}\,N\, \text{é conhecido e houver ordenação das unidades na população}$                         


$\displaystyle V_{AS}(\overline y_{AS})=\frac K{N^2}\sum_{r=1}^K(t_r-\overline t)^2$   $\widehat V_{1AS} (\overline y_{AS}) = \left( \frac {1}{n} - \frac 1 {N} \right) \frac {1}{n-1}\displaystyle \sum_{i \in s_r} (y_i - \overline y_{AS})^2\scriptstyle,$ 
                                                                                       $\scriptstyle \text{se}\, N\, \text{é conhecido e não houver ordenação das unidades na população}$                                                                        $\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,$                                                                                                                                               $\widehat V_{2AS}(\overline y_{AS}) = \left( \frac {1}{n} - \frac 1 {N} \right) \frac {1}{2(n-1)} \displaystyle\sum_{i \in s_r} (y_i - y_{i+K})^2\scriptstyle,$
                                                                                       $\scriptstyle \text{se}\,N\, \text{é conhecido e houver ordenação das unidades na população}$                 
----------
</center>  
...
$\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,n=$ 115; $\,N=$ 2.300; $\,\sum_{i=1}^ny_i=$ 407,1 e $\,\sum_{i=1}^ny_i^2=$ 2.011,15
