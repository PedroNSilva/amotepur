...
cat("<table>",paste0("<caption>", "(#tab:tabsis1)","Unidades que compõem as possíveis $K$ amostras sistemáticas, $s_1,   s_2,   ...,s_r,   ...,   s_K$, com partida aleatória $r$ no intervalo $[1,   2,   ...,   K]$", "</caption>"),"</table>", sep ="\n")
```
----------
...
\\& \doteq  & \left[ 1 + (n-1)\rho \right] \frac {S_y^2} {n} \, \,  (\#eq:eqsis8)
\end{array}
$$ 
...
<center>
```{r,results="asis",echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabsis6)","Parâmetros e Estimadores sob AS", "</caption>"),"</table>", sep ="\n")
```
----------
...
Veja que com uma *Amostra Sitemática circular - ASc*, o número de amostras possíveis é $N$ e pode-se definir estimadores não viciados para a média e o total da variável de interesse $y$, como:
$$
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabsis7)","Composição dos domicílios da rua","</caption>"),"</table>", sep ="\n")
```
----------
