...
cat("<table>",paste0("<caption>", "(#tab:tabprop1)","Estimadores de contagens e proporções sob *AASC*", "</caption>"),"</table>", sep ="\n")
```
...
```{r,results="asis",echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabprop2)","Estimadores de contagens e proporções sob *AAS*", "</caption>"),"</table>", sep ="\n")
```
