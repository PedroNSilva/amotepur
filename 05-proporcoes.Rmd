...
\begin{equation} 
\displaystyle IC(p;{1-\alpha})=\left[\widehat p \mp \left(z_{\alpha/ 2}\sqrt {{p(1-P)}/n}+1/2n \right) \right] (\#eq:eqpro31) \end{equation}
...
\begin{equation}
\displaystyle y_i= \begin{cases} 1, \text { se a unidade} \textit{ i } \text{pertence à categoria $c$} \\ 0, \text { se a unidade}\textit{ i } \text{ pertence a outra categoria} \end{cases}(\#eq:eqpro45)
\end{equation}
