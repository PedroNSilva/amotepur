...
\begin{equation}
y_i=\displaystyle \begin{cases} 1, \text {se a unidade i possui o atributo} \\\\ 0, \text {em outro caso} \end{cases}(\#eq:eqpro1)
\end{equation}
...
\begin{equation}
\displaystyle v_{AASC}(\widehat p)=\frac{\widehat p\widehat q}{n-1}(\#eq:eqpro11) 
\end{equation}
...
\begin{equation}
y_i=\displaystyle \begin{cases} 1,\text{ se a unidade i tem o atributo} \\\\ 0,\text{ em outro caso} \end{cases}(\#eq:eqpro12) \end{equation}
...
\begin{equation}
V_{AAS}(\overline y)=\frac {N-n}{N}\frac{S^2_y}{n}(\#eq:eqpro17) 
\end{equation}
...
\begin{equation}
v_{AAS}(\widehat p)=\frac {N-n}{N} \frac {\widehat p \widehat q}{n-1}(\#eq:eqpro19) 
\end{equation}
...
\begin{equation}
y_i=\displaystyle\begin{cases} 1,\text{ se a unidade i tem o atributo} \\\\ 0,\text{ em outro caso} \end{cases}(\#eq:eqpro20) 
\end{equation}
...
\begin{equation}
v_{AAS}(\widehat p)= \left(\frac{N-n}{N}\right)\frac {\widehat p\widehat q}{n-1}(\#eq:eqpro25) 
\end{equation}
