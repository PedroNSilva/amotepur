...
cat("<table>",paste0("<caption>", "(#tab:tabprop1)","Parâmetros e respectivos estimadores sob AASC", "</caption>"),"</table>", sep ="\n")
```
----------
...
```{r,results="asis",echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabprop2)","Parâmetros e respectivos estimadores sob AAS", "</caption>"),"</table>", sep ="\n")
```
