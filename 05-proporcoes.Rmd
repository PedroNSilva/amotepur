...
cat("<table>",paste0("<caption>", "(#tab:tabprop1)","Principais resultados de contagens e proporções sob *AASC*", "</caption>"),"</table>", sep ="\n")
```
...
Foi visto no Capítulo \@ref(cap:aas) que as variâncias dos estimadores do total e da média são dadas pelas expressões:
...
```{r,results="asis",echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabprop2)","Principais resultados de contagens e proporções sob *AAS*", "</caption>"),"</table>", sep ="\n")
```
...
$\displaystyle V_{AAS}(\widehat N_A)= N^2\left(\frac1 n-\frac1 N\right)S^2_y$         $\displaystyle\widehat V_{AAS}(\widehat N_A)=N^2\left(\frac 1 n-\frac {1}{N}\right)\frac{\widehat p (1-\widehat p)}{n-1}$  
                                                                                                                                                                                                              
$\displaystyle V_{AAS}(\widehat p)=\displaystyle\left(\frac1 n-\frac1 N\right)S^2_y$  $\displaystyle\widehat V_{AAS}(\widehat p)=\left(\frac 1 n-\frac{1}{N}\right)\frac{\widehat p(1-\widehat p)} {n-1}$       
...
<center>
```{r,figprop1,echo=F,fig.cap="aproximação Normal no caso de uma *AASC*"}
x=0
s=0
...
<center>
```{r,figprop2,echo=F,fig.cap="Aproximação Normal no caso de uma *AAS*"}
x=0
s=0
...
<center>
```{r,results="asis",echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabprop3)","Valores mínimos de $t_y$ para uso da aproximação Normal", "</caption>"),"</table>", sep ="\n")
```
...
<center>
```{r, figprop3,fig.cap="Variação de $pq$ em função dos valores de $p$",echo=F}
p=seq(0,1, by=0.001)
pq=p*(1-p)
