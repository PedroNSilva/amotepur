...
<center>
```{r,results="asis",echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis4)","Probabilidade sob $p_1$ para cada valor de $2 \times t$", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis13)", "Obtenção da variância dos estimadores sob os planos amostrais $p_1$ e $p_2$", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis15)", "Valores de variáveis de interesse para cada domicílio da população", "</caption>"),"</table>", sep ="\n")
```
----------
