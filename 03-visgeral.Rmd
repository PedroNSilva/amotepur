...
cat("<table>",paste0("<caption>", "(#tab:tabvis1)","Valor da variável $y$ por unidade da população de mulheres", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r,results="asis",echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis2)","Informações de cada amostra possível sob plano amostral $p_1$", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r,results="asis",echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis3)","Probabilidade sob $p_1$ para cada valor de $t$", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r,results="asis",echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis4)","Probabilidade sob $p_1$ para cada valor de $2t$", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis7)", "Informações de cada amostra possível sob plano amostral $p_2$", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis8)", "Probabilidade sob $p_2$ para cada valor de $t$", "</caption>"),"</table>", sep ="\n")
```
----------
Valores possíveis de $t$      0     1     2     3
--------------------------- ----- ----- ----- -----
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis10)", "Obtenção de estimativa sob plano amostral $p_2$ para cada amostra possível", "</caption>"),"</table>", sep ="\n")
```
----------------------------------------------------------------------------------------------------------------------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis13)", "Obtenção da variância dos estimadores sob os planos amostrais $p_2$ e $p_1$", "</caption>"),"</table>", sep ="\n")
```
------------------------------------------------------------------------------------------------------------------------------------------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis14)", "Representação de cada amostra possível pelas variáveis indicadoras", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis15)", "Parâmetros e respectivos estimadores HT", "</caption>"),"</table>", sep ="\n")
```
----------
Parâmetro                                                   Estimador
----------------------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------------             
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis16)", "Valores de variáveis de interesse para cada domicílio da população", "</caption>"),"</table>", sep ="\n")
```
----------
