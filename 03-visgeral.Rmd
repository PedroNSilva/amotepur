...
names(tabela)<- c("**Amostra**","**Unidades na Amostra $s$**","**Valores na Amostra $s$**","**Soma Amostral $(t)$**","**Probabilidades $p_1(s)$**")
knitr::kable(tabela, booktabs = TRUE, align= "ccccc",
       caption= "Informações de cada amostra possível sob plano amostral $p_1$")%>%
kable_styling(full_width = F)
```  
...
knitr::kable(tabela, booktabs = TRUE, align= "lcccc",
       caption= "Probabilidade sob $p_1$ para cada valor de $t$")%>%
kable_styling(full_width = F)
```
...
knitr::kable(tabela, booktabs = TRUE, align= "lcccc",
       caption= "Probabilidade sob $p_1$ para cada valor de 2 x $t$")%>%
kable_styling(full_width = F)
```
...
tabela <- data.frame (x1,x2,x3,x4,x5)
names(tabela)<- c("**Amostra**","**Unidades na Amostra $s$**","**Valores na Amostra $s$**","**Soma Amostral $(t)$**","**Probabilidades $p_2(s)$**")
knitr::kable(tabela, booktabs = TRUE, align= "ccccc",
       caption= "Informações de cada amostra possível sob plano amostral $p_2$")
```
...
knitr::kable(tabela, booktabs = TRUE, align= "lcccc",
       caption= "Probabilidade sob $p_2$ para cada valor de $t$")%>%
kable_styling(full_width = F)
```
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis9)", "Probabilidade de inclusão e peso amostral de cada unidade sob o plano amostral $p_2$", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
...
tabela <- data.frame (x1,x2,x3,x4,x5)
names(tabela)<- c("**Amostra**","**Valores na Amostra $s$**","**Total Amostral ponderado**","**Probabilidades $p_2(s)$**", "**Total x probabilidade**")
knitr::kable(tabela, booktabs = TRUE, align= "ccccc",
       caption= "Obtenção de estimativa sob plano amostral $p_2$ para cada amostra possível") %>%
kable_styling(full_width = F)
```
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis11)", "Probabilidade de seleção sob $p_1(s)$ para cada valor do estimador ponderado", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabvis12)", "Probabilidade de seleção sob $p_2(s)$ para cada valor do estimador ponderado", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
...
tabela <- data.frame (x1,x2,x3,x4,x5,x6)
names(tabela)<- c("**Amostra**","**Valores na Amostra $s$**","**Estimativa sob $p_2$**","**Probabilidade sob $p_2$**", "**Estimativa sob $p_1$**", "**Probabilidade sob $p_1$**")
knitr::kable(tabela, booktabs = TRUE, align= "cccccc",
       caption= "Obtenção da variância dos estimadores sob os planos amostrais $p_1$ e $p_2$")
```
