...
A Tabela \@ref(tab:tabaas2) apresenta um resumo da estimação de parâmetros média e total sob AASC.

```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabaas2)", "Resumo de estimadores dos parâmetros média e total sob AASC", "</caption>"),"</table>", sep ="\n")
```
<center>
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabaas5)", "Resumo de estimadores dos parâmetros média e total sob AAS", "</caption>"),"</table>", sep ="\n")
```
<center>
...
# d. Tamanho de amostra para obter margem de erro relativo de 2% ao nível 95%
(dr <- 0.02)
