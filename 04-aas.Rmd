...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabaas2)", "Estimadores do total, média e respectivas variâncias sob AASC", "</caption>"),"</table>", sep ="\n")
```
----------
Estimador
---------------------------------------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabaas5)", "Estimadores do total, média e respectivas variâncias sob AAS", "</caption>"),"</table>", sep ="\n")
```
-----------
Estimador
-----------------------------------------
...
2)	Fazer *amostra prévia* (*amostra piloto*) e estimar $S_y^2$ usando $\widehat S_y^2$ com os dados dessa amostra prévia.
