...
cat("<table>",paste0("<caption>", "(#tab:tabaas1)", "Resumo de estimadores dos parâmetros média e total sob AASC", "</caption>"),"</table>", sep ="\n")
```
<center>
...
```{r myDThtmltools2, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabaas2)", "Resumo de estimadores dos parâmetros média e total sob AAS", "</caption>"),"</table>", sep ="\n")
```
<center>
