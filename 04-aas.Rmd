...
é *ENV* do *total populacional* $Y$ sob AAS. 
...
\begin{equation}
\frac{\overline {y}-E_{AAS}(\overline{y})}{\sqrt{V_{AAS}(\overline{y})}}=\frac{\overline {y}-\overline{Y}}{\sqrt{\left(\frac{1}{n}-\frac{1}{N}\right)S_y^2}}\approx N(0;1) (\#eq:eqaas7)
\end{equation}
...
\begin{equation}
n = \frac{1}{\left( \frac{d}{z_{\alpha/2}} \right)^2 \frac{1}{S_y^2} + \frac{1}{N}} = \frac{N z_{\alpha/2}^2 S_Y^2} {N{d}^2 + {z_{\alpha/2}^2} S_y^2} (\#eq:eqaas10)
\end{equation}
