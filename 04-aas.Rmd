...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabaas2)", "Parâmetros e respectivos estimadores sob AASC", "</caption>"),"</table>", sep ="\n")
```
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabaas5)", "Parâmetros e respectivos estimadores sob AAS", "</caption>"),"</table>", sep ="\n")
```
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabaas6)", "Estatísticas obtidas a partir da amostra", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabaas7)", "Gastos apurados nas obras da amostra", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabaas8)", "Salários pagos pelas empresas da amostra", "</caption>"),"</table>", sep ="\n")
```
----------
Empresa            1    2    3   4   5
----------------- --- ---- ---- --- ---
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabaas9)", "Frequências das respostas obtidas na amostra", "</caption>"),"</table>", sep ="\n")
```
----------
 Frequência $(f_i)$   $y_i$
-------------------- ------
