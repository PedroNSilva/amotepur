...
knitr::include_graphics("Figuras/processodepesqmodelo.png")
```
...
### Analisar - análise, interpretação e assegurar a confidencialidade das informações individualizadas
