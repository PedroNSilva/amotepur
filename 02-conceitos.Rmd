...
<center>
```{r, umparaum, echo=FALSE, fig.cap="Ilustração da regra de associação um para um",out.width = '70%'}
...
<center>
```{r, umparavar, echo=FALSE, fig.cap="Ilustração da regra de associação um para vários",out.width = '70%'}
...
<center>
```{r, varparaum1, echo=FALSE, fig.cap="Ilustração da regra de associação vários para um",out.width = '70%'}
knitr::include_graphics("Figuras/Associavarios-1a.PNG")
```


```{r, varparaum2, echo=FALSE, fig.cap="Ilustração da regra de associação vários para um",out.width = '70%'}
...
<center>
```{r, hierarquia, echo=FALSE, fig.cap="Ilustração de regras de associação - hierarquia para vários níveis",out.width = '70%'}
