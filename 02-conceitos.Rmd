...
```{r, cadset, echo=FALSE, fig.cap="O cadastro de setores do IBGE - Copacabana - RJ"}
...
```{r, cnefe1, echo=FALSE, fig.cap="Informações do CNEFE para um setor de Copacabana - RJ"}
knitr::include_graphics("Figuras/Dadossetor.PNG")
```


```{r, cnefe2, echo=FALSE, fig.cap="Ilustração de dados do CNEFE"}
...
```{r, umparaum, echo=FALSE, fig.cap="Ilustração da regra de associação um para um"}
...
```{r, umparavar, echo=FALSE, fig.cap="Ilustração da regra de associação um para vários"}
...
```{r, varparaum1, echo=FALSE, fig.cap="Ilustração da regra de associação vários para um"}
knitr::include_graphics("Figuras/Associavarios-1a.PNG")
```


```{r, varparaum2, echo=FALSE, fig.cap="Ilustração da regra de associação vários para um"}
...
```{r, hierarquia, echo=FALSE, fig.cap="Ilustração de regras de associação - hierarquia para vários níveis"}
