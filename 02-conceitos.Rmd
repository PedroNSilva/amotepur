...
cat("<table>",paste0("<caption>", "(#tab:tabconc1)","Exemplos de definições de populações de pesquisa", "</caption>"),"</table>", sep ="\n")
```
----------
...
<center>
```{r, modpesq, echo=FALSE, encoding="UTF-8", fig.cap="Modelo Genérico do Processo de Produção Estatística, adaptado",out.width = '100%'}
...
A cada ano, é extraído do CEMPRE um *Cadastro Básico de Seleção* usado na seleção das amostras das pesquisas econômicas anuais, tais como a Pesquisa Anual da Indústria da Construção - PAIC, a Pesquisa Industrial Anual - PIA-Empresa, a Pesquisa Anual do Comércio - PAC e a Pesquisa Anual de Serviços - PAS. Além destas pesquisas econômicas anuais, o CEMPRE também serve de base para a extração de amostras das pesquisas conjunturais do IBGE, tais como a Pesquisa Industrial Mensal de Produção Física - PIM-PF, a Pesquisa Mensal do Comércio - PMC e a Pesquisa Mensal dos Serviços - PMS. 
...
<center>
```{r, cadset, echo=FALSE, fig.cap="O cadastro de setores do IBGE - Copacabana - RJ",out.width = '100%'}
...
<center>
```{r, cnefe1, echo=FALSE, fig.cap="Informações do CNEFE para um setor de Copacabana - RJ",out.width = '100%'}
knitr::include_graphics("Figuras/Dadossetor.PNG")
```


```{r, cnefe2, echo=FALSE, fig.cap="Ilustração de dados do CNEFE",out.width = '100%'}
...
<center>
```{r, umparaum, echo=FALSE, fig.cap="Ilustração da regra de associação um para um",out.width = '100%'}
knitr::include_graphics("Figuras/Associa1-1.PNG")
```
</center>
...
knitr::include_graphics("Figuras/Associa1-varios.PNG") 
```
</center>
...
<center>
```{r, varparaum1, echo=FALSE, fig.cap="Ilustração da regra de associação vários para um",out.width = '100%'}
knitr::include_graphics("Figuras/Associavarios-1a.PNG")
```


```{r, varparaum2, echo=FALSE, fig.cap="Ilustração da regra de associação vários para um",out.width = '100%'}
