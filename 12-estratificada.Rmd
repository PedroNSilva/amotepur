...
\begin{equation}
p_h(a_h)=1/\binom {N_h}{n_h}= \binom {N_h}{n_h}^{-1}\,\,\,, \,\,h=1,2,\dots,H\,\,(\#eq:eqest1)
\end{equation}
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabestr3)", "Resumo de estimadores dos parâmetros média e total sob AES", "</caption>"),"</table>", sep ="\n")
```
<center>
---------
