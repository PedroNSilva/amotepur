...
6. Conforme @Sarndal1992 (p. 65), uma aproximação da variância do estimador alternativo de total é dada por:
...
8. Conforme @Sarndal1992 (p. 63), a variância do estimador simples do total pode ser reescrita como:

$$
V_{AB}(\widehat Y_{AB}) = N^2\left(\frac{1}{N\pi} - \frac{1}{N}\right)S_y^2 \left[1 - \frac{1}{N} + \frac{1}{CV_y^2}\right]\,\,(\#eq:eqbin6)
$$   

9. Logo, de acordo com @Sarndal1992 (p. 65), a eficiência relativa do estimador alternativo é dada por:
