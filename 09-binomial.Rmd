...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabbin2)", "Valores observados na amostra", "</caption>"),"</table>", sep ="\n")
```  
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabbin3)", "População a ser amostrada", "</caption>"),"</table>", sep ="\n")
```  
----------
   i            I    II   III    IV     V
----------- ----- ----- ----- ----- -----
...
**(#exr:exerbin5)** Uma lista com 10875 denúncias, contra uma determinada entidade, foi enviada a um analista para que fossem avaliadas. Sabendo que nem todas as denúcias seriam procedentes, o analista resolveu selecionar uma amostra dos processos para estimar o total das denúncias procedentes, seguindo os seguintes passos:
...
c)  Sabendo que na amostra foram observadas 85 denúncias procedentes, a estimativa do total de procedentes na população é 8500;
