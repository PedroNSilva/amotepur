...
cat("<table>",paste0("<caption>", "(#tab:tabbin1)","Estimadores do total, média e respectivas variâncias sob AB", "</caption>"),"</table>", sep ="\n")
```
...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabbin1a)", "Estimadores do total, média e respectivas variâncias sob AIS", "</caption>"),"</table>", sep ="\n")
```  
<center>
