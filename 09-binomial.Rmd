...
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabbin2)", "Estimadores do total, média e respectivas variâncias sob AIS", "</caption>"),"</table>", sep ="\n")
```  
<center>
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabbin3)", "Valores observados na amostra", "</caption>"),"</table>", sep ="\n")
```  
----------
...
<center>
```{r, results="asis", echo=FALSE}
cat("<table>",paste0("<caption>", "(#tab:tabbin4)", "População a ser amostrada", "</caption>"),"</table>", sep ="\n")
```  
----------
   i            I    II   III    IV     V
----------- ----- ----- ----- ----- -----
